...
export const REQUIRED_DOCUMENTS = [
  { key: 'adhar_details', name: 'Adhar Details' },
...
const NAME_TO_KEY = {
  ADHAR_DETAILS: 'adhar_details',
  AADHAR_DETAILS: 'adhar_details',
  AADHAAR_DETAILS: 'adhar_details',
  AADHAR_CARD: 'adhar_details',
  AADHAAR_CARD: 'adhar_details',
